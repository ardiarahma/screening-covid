...
<div class="content">
    <div class="panel panel-flat">
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('covid-skor.update',$data->id)}}" method="post" enctype="multipart/form-data" files=true>
            @method('PUT')
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="hasil" class="form-control" value="{{ old('hasil') ? old('hasil') : $data->hasil }}" placeholder="">
                        @if ($errors->has('hasil'))
